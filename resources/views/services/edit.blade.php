        ...
        <div class="card-body">
            <form action="{{ route('admin.services.update', $service->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="number" class="form-control @error('tax_rate') is-invalid @enderror" id="tax_rate" name="tax_rate" value="{{ old('tax_rate', $service->tax_rate ?? 16) }}" step="0.01" min="0" max="100" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control @error('special_requirements') is-invalid @enderror" id="special_requirements" name="special_requirements" rows="3">{{ old('special_requirements', $service->special_requirements) }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control @error('materials_included') is-invalid @enderror" id="materials_included" name="materials_included" rows="3">{{ old('materials_included', $service->materials_included) }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="requires_technician_approval" name="requires_technician_approval" {{ old('requires_technician_approval', $service->requires_technician_approval) ? 'checked' : '' }}>
