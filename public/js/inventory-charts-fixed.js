...
document.addEventListener("DOMContentLoaded", function () {
    console.log(
        "%c[INVENTORY CHARTS] Inicializando sistema de gráficos...",
    ...
    try {
        ...
        if (dataScript) {
            try {
                ...
                console.log(
                    "✓ Datos cargados desde elemento script",
                    inventoryData
                );
            } catch (parseError) {
                console.error(
                    "Error al parsear datos desde script:",
                    parseError
                );
            }
        }
        ...
        if (!inventoryData.categoryLabels && window.inventoryData) {
            ...
            console.log(
                "✓ Datos cargados desde variable global",
                inventoryData
            );
        }
        ...
        if (
            ...
            !Array.isArray(inventoryData.categoryLabels)
        ) {
    ...
    function initSummaryChart(labels, data) {
        ...
        if (!canvas) {
            console.error(
                "No se encontró el elemento canvas para el gráfico de resumen"
            );
            return;
        }
        ...
        try {
            ...
            console.warn(
                "No se pudo obtener/destruir gráfico existente:",
                error
            );
        }
        ...
        if (window.innerWidth >= 992) {
            ...
            setTimeout(function () {
                ...
                if (maxHeight > 0) {
                    ...
                    $(".chart-container, .stock-list").css(
                        "height",
                        contentHeight + "px"
                    );
                }
