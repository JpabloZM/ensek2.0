...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const calendar = document.querySelector('.technician-calendar-container');
        if (!calendar) return;
        ...
        const setFixedDimensions = function() {
            ...
            const techCells = document.querySelectorAll('.calendar-header-tech');
            if (techCells.length > 0) {
                ...
                techIds.forEach(techIndex => {
                    const serviceCells = document.querySelectorAll(`.calendar-service-cell:nth-child(${techIndex + 2})`);
        ...
        const disableTransitionsDuringInteraction = function() {
            document.querySelectorAll('.calendar-service-cell, .calendar-header-tech').forEach(cell => {
            ...
            document.addEventListener('mousedown', function(e) {
                ...
                if (targetCell && !targetCell.querySelector('.calendar-service')) {
