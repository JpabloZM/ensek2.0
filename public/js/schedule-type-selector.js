...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function setupScheduleTypeSelection() {
        ...
        window.abrirModalDirecto = function (data = {}) {
            console.log(
                "🚀 Ejecutando función global abrirModalDirecto()",
                data
            );

            if (!modalDirecto) {
                console.error(
                    "❌ Modal directo no encontrado en la función global"
                );
                return false;
            }
            ...
            try {
                ...
                console.warn(
                    "⚠️ Error al abrir modal con método nativo:",
                    error
                );
                ...
                try {
                    ...
                    console.warn(
                        "⚠️ Error al abrir modal con jQuery:",
                        jqError
                    );
                }
                ...
                try {
                    ...
                    const btnAux =
                        document.getElementById("btnOpenDirectModal");
                    if (btnAux) {
                        btnAux.click();
        ...
        window.handleNewDirectService = function (data = {}) {
            console.log(
                "🔄 Manejando selección de servicio nuevo directo",
                data
            );
