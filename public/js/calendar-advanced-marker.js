...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        ...
        window.showSelectionMarker = function(startCell, endCell, timeRange) {
            ...
            if (timeRange) {
                selectionMarker.querySelector('.selection-marker-header').textContent = timeRange;
            }
            ...
            mutations.forEach(function(mutation) {
                if (mutation.type === 'attributes' && 
                    ...
                    if (overlay.style.display !== 'none') {
                        ...
                        const timeRange = overlay.querySelector('.selection-time')?.textContent || '';
                        ...
                        if (selectedCells.length > 0) {
                            ...
                            window.showSelectionMarker(firstCell, lastCell, timeRange);
                        }
                    } else {
