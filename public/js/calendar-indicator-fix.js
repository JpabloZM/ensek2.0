...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        ...
        const observer = new MutationObserver(function(mutations) {
            ...
            const indicators = document.querySelectorAll('.fc-timeline-now-indicator-line, .fc-timeline-now-indicator-arrow');
            
            indicators.forEach(function(indicator) {
                // Comprobar si es la flecha (etiqueta) del indicador
                if (indicator.classList.contains('fc-timeline-now-indicator-arrow')) {
