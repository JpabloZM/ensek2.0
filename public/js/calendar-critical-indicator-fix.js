...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fixTimeIndicator() {
        ...
        const indicators = document.querySelectorAll('.fc-timeline-now-indicator-line');
        indicators.forEach(indicator => {
            // Forzar z-index bajo y posicionamiento
            indicator.style.cssText += 'z-index: 1 !important; position: absolute !important;';
        ...
        const headers = document.querySelectorAll('.fc-datagrid-header, .fc-timeline-header');
        headers.forEach(header => {
            header.style.cssText += 'z-index: 9999 !important; position: relative !important; background: #fff !important;';
        });
        ...
        if (!document.getElementById('header-overlay')) {
            ...
            const headerHeight = document.querySelector('.fc-datagrid-header')?.offsetHeight || 50;
            ...
            window.addEventListener('resize', () => {
                const newHeaderHeight = document.querySelector('.fc-datagrid-header')?.offsetHeight || 50;
