...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function handle8To10Selection(formId) {
        ...
        const dateInput = document.getElementById(
            formId === "direct" ? "direct_scheduled_date" : "scheduled_date"
        );
        const startTimeInput = document.getElementById(
            formId === "direct" ? "direct_start_time" : null
        );
        const endTimeInput = document.getElementById(
            formId === "direct" ? "direct_end_time" : "end_time"
        );
        const durationInput = document.getElementById(
            formId === "direct" ? "direct_duration" : "duration"
        );
        ...
        if (hours === 8 && minutes === 0) {
            console.log(
                "✅ Detectada selección de 8:00 AM - ajustando a 2 horas"
            );
            ...
            console.log(
                `⏱️ Ajustado a 8:00 - 10:00 (${durationInput.value} minutos)`
            );
